...
{
    public class PrtnCertificateBojxonaConsumerConfig : IConsumerConfig<PrtnCertificateBojxonaMessage>
    {
    ...
    public class PrtnCertificateBojxonaConsumer : StatusGenericHandler, IConsumer<PrtnCertificateBojxonaMessage>
    {
        ...
        public PrtnCertificateBojxonaConsumer(IPrtnCertificateService prtnCertificateService,
            IDocumentJobHistoryService documentJobHistoryService,
            IAuthService authService,
            ILogger<PrtnCertificateBojxonaConsumer> logger,
        ...
        public async Task ConsumeAsync(PrtnCertificateBojxonaMessage message, CancellationToken cancellationToken)
        {
