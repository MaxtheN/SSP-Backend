...
namespace SspUis.RabbitMQ.Consumers.Certificate
{
    public class PrtnCertificateMoliyaConsumerConfig : IConsumerConfig<PrtnCertificateMoliyaMessage>
    {
        public string Name => "PrtnCertificateBojxonaSync";
        public RabbitQueue Queue => Queues.Partner.PrtnCertificateBojxona;
        public ushort PrefetchCount { get; set; } = 1;
        public int WorkerCount { get; set; } = 1;
        public bool RequeueOnFailed { get; set; }
    }
    public class PrtnCertificateMoliyaConsumer : StatusGenericHandler, IConsumer<PrtnCertificateMoliyaMessage>
    {
        ...
        public PrtnCertificateMoliyaConsumer(IPrtnCertificateService prtnCertificateService,
            IDocumentJobHistoryService documentJobHistoryService,
            IAuthService authService,
            ILogger<PrtnCertificateMoliyaMessage> logger,
        ...
        public async Task ConsumeAsync(PrtnCertificateMoliyaMessage message, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _prtnCertificateService.SentForOtherServiceFormedCertificate(message.DocId, EnumTypeOrganization.Bojxona);
