...
{
    public abstract class DocumentJobService<TEntity, TPublisher, TMessage> : StatusGenericHandler
        where TEntity : class, IJobDocumentEntity
        where TPublisher : PublisherBase<TMessage>
        where TMessage : DocumentMessage
    {
        ...
        protected HaveId<long> Run(long id, int toStatusId)
        {
            ...
            var entity = _repository.ById(id, applyFilter:false);
        ...
        private HaveId<long> Run(TMessage message, TEntity entity, int toStatusId)
        {
            ...
            else if (entity is SspUis.DataLayer.EfClasses.PrtnCertificate)
            {
            }
            else if (entity is SspUis.DataLayer.EfClasses.MonoApplication)
            {
            }
            else
            {
