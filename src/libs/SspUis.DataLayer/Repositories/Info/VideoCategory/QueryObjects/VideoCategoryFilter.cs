...
{
    public static class VideoCategoryFilter
    {
        public static IQueryable<VideoCategory> ByNumberCode(this IQueryable<VideoCategory> source, string numberCode, bool isIncludePassive = false)
        {
