...
{
    public class ServiceDeedTableDlDto
        : EntityDto<ServiceDeedTableDlDto, ServiceDeedTable>,
        IHaveIdProp<long>,
        ILinkToEntity<ServiceDeedTable>
    {
        ...
        public override ServiceDeedTable CreateEntity()
        {
            var entity = base.CreateEntity();
            return entity;
        }

        public override void UpdateEntity(ServiceDeedTable entity)
        {
