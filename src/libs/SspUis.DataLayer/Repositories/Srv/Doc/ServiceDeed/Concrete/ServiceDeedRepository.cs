...
{
    public class ServiceDeedRepository
        : BaseEntityRepository<long, ServiceDeed, CreateServiceDeedDlDto, UpdateServiceDeedDlDto, UpdateStatusServiceDeedDlDto>
        , IServiceDeedRepository
    {
        private readonly IAuthService _authService;
        private readonly ICrudServices _crudService;
        private readonly IUnitOfWork _unitOfWork;
        public ServiceDeedRepository(
        ...
        protected override void OnCreate(ServiceDeed entity, CreateServiceDeedDlDto dto)
        {
        ...
        protected override void OnUpdate(ServiceDeed entity, UpdateServiceDeedDlDto dto)
        {
            base.OnUpdate(entity, dto);
            SetEntityProperties(dto, entity);
        }

        private void SetEntityProperties<TDto>(ServiceDeedDlDto<TDto> dto, ServiceDeed entity)
              where TDto : ServiceDeedDlDto<TDto>
        {
            //if (dto is UpdateServiceDeedDlDto)
            //{
        ...
        protected override IQueryable<ServiceDeed> InjectFilter(IQueryable<ServiceDeed> query)
        {
        ...
        protected override IQueryable<ServiceDeed> ByIdQuery()
        {
