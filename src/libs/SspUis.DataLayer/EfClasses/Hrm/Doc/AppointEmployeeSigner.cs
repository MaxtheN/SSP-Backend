...
{
    [Table("doc_appoint_employee_signer", Schema = "hrm")]
    [Index(nameof(OwnerId), nameof(SignOrder), Name = "ux_doc_appoint_employee_signer", IsUnique = true)]
    public partial class AppointEmployeeSigner : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
