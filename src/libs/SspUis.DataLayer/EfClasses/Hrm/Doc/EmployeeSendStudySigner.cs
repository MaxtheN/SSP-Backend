...
{
    [Table("doc_employee_send_study_signer", Schema = "hrm")]
    public partial class EmployeeSendStudySigner : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
        ...
        [InverseProperty(nameof(EmployeeSendStudy.Signer))]
