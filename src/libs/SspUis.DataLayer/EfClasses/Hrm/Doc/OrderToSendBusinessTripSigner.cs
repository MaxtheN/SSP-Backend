...
{
    [Table("doc_order_to_send_business_trip_signer", Schema = "hrm")]
    [Index(nameof(OwnerId), nameof(SignOrder), Name = "ux_doc_order_to_send_business_trip_signer", IsUnique = true)]
    public partial class OrderToSendBusinessTripSigner : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
