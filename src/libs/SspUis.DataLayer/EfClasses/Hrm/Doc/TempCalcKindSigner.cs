...
{
    [Table("doc_temp_calc_kind_signer", Schema = "hrm")]
    [Index(nameof(OwnerId), nameof(SignOrder), Name = "ux_doc_temp_calc_kind_signer", IsUnique = true)]
    public partial class TempCalcKindSigner : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
