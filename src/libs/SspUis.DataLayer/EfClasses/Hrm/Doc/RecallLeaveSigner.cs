...
{
    [Table("doc_recall_leave_signer", Schema = "hrm")]
    [Index(nameof(OwnerId), nameof(SignOrder), Name = "ux_doc_recall_leave_signer", IsUnique = true)]
    public partial class RecallLeaveSigner : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
