...
{
    [Table("doc_employee_send_train_signer", Schema = "hrm")]
    [Index(nameof(OwnerId), nameof(SignOrder), Name = "ux_doc_employee_send_train_signer", IsUnique = true)]
    public partial class EmployeeSendTrainSigner : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
