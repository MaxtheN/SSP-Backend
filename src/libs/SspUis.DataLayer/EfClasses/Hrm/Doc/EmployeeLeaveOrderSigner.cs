...
{
    [Table("doc_employee_leave_order_signer", Schema = "hrm")]
    [Index(nameof(OwnerId), nameof(SignOrder), Name = "ux_doc_employee_leave_order_signer", IsUnique = true)]
    public partial class EmployeeLeaveOrderSigner : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
