...
{
    [Table("doc_service_contract_sign", Schema = "srv")]
    [Index(nameof(OwnerId), Name = "ix_doc_service_contract_sign__owner")]
    public class ServiceContractSign : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
        ...
        [InverseProperty(nameof(ServiceContract.Signs))]
