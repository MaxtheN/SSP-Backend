...
[Table("doc_arbitration_discussion_sign", Schema = "arbitration")]
[Index(nameof(OwnerId), Name = "ix_doc_arbitration_discussion_sign__owner")]
public class ArbitrationDiscussionSign : IHaveIdProp<long>
{
    [Key]
    [Column("id")]
    ...
    //[InverseProperty(nameof(ArbitrationDiscussion.Signs))]
    public virtual ArbitrationDiscussion Owner { get; set; }
