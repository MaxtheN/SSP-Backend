...
[Table("doc_arbitration_court_application_signer", Schema = "arbitration")]
[Index(nameof(OwnerId), nameof(SignOrder), Name = "ux_doc_chastisement_signers", IsUnique = true)]
public partial class ArbitrationCourtApplicationSigner : IHaveIdProp<long>
{
    [Key]
    [Column("id")]
    ...
    [InverseProperty(nameof(ArbitrationCourtApplication.Signer))]
