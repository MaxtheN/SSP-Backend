...
{
    [Table("doc_appeal_application_sign", Schema = "appeal")]
    [Index(nameof(OwnerId), Name = "ix_doc_appeal_application_sign__owner")]
    public partial class AppealApplicationSign : IHaveIdProp<long>
    {
        [Key]
        [Column("id")]
        ...
        [InverseProperty(nameof(AppealApplication.Signs))]
