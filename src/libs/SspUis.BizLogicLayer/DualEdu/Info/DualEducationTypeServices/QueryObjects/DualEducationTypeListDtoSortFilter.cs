...
{
    public static class DualEducationTypeListDtoSortFilter
    {
        public static IQueryable<DualEducationTypeListDto> SortFilter(this IQueryable<DualEducationTypeListDto> query, ISortFilterOptions options)
        {
