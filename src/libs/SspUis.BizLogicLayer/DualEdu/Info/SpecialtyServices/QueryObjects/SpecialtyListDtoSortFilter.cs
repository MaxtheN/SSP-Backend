...
{
    public static class SpecialtyListDtoSortFilter
    {
        public static IQueryable<SpecialtyListDto> SortFilter(this IQueryable<SpecialtyListDto> query, ISortFilterOptions options)
        {
            if (options.HasSearch())
                query = query.Where(a => a.ShortName.ToLower().Contains(options.Search.ToLower()) ||
                                         ...
                                         a.TextCode.ToLower().Contains(options.Search.ToLower()) ||
