...
{
    public class SpecialtyDtoConfig : PerDtoConfig<SpecialtyDto, Specialty>
    {
        public override Action<IMappingExpression<Specialty, SpecialtyDto>> AlterReadMapping => cfg => cfg
