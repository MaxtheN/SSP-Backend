...
{
    public static class InstituteListDtoSortFilter
    {
        public static IQueryable<InstituteListDto> SortFilter(this IQueryable<InstituteListDto> query, ISortFilterOptions options)
        {
