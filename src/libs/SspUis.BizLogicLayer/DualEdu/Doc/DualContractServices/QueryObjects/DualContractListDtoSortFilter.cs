...
public static class DualContractListDtoSortFilter
{
    public static IQueryable<DualContractListDto> SortFilter(this IQueryable<DualContractListDto> query
    , DualContractDtoSortFilterOptions options)
    {
