...
public class SignCriterionListDtoConfig : PerDtoConfig<SignCriterionListDto, SignCriterion>
{
    public override Action<IMappingExpression<SignCriterion, SignCriterionListDto>> AlterReadMapping => cfg => cfg
