...
public static class AppealApplicationListDtoSortFilter
{
    public static IQueryable<AppealApplicationListDto> SortFilter(this IQueryable<AppealApplicationListDto> query
    , AppealApplicationSortFilterOptions options)
    {
