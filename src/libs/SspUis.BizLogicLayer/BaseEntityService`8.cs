...
{
    public abstract class BaseEntityService<TId, TEntity, TListDto, TDto, TCreateDlDto, TUpdateDlDto, TRepository, TSortFilterPageOptions>
        : StatusGenericHandler, IBaseEntityService<TId, TEntity, TListDto, TDto, TCreateDlDto, TUpdateDlDto, TSortFilterPageOptions>
        where TId : struct
        ...
        where TSortFilterPageOptions : class, IPageOptions
    {
        ...
        public virtual HaveId<TId> Create(TCreateDlDto dto)
        {
