...
{
    public class PrtnCertificateSignDtoConfig : PerDtoConfig<PrtnCertificateSignDto, PrtnCertificateSign>
    {
        public override Action<IMappingExpression<PrtnCertificateSign, PrtnCertificateSignDto>> AlterReadMapping =>
            cfg => cfg
