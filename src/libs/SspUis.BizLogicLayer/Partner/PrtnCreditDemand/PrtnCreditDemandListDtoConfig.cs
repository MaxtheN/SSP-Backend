...
{
    public class PrtnCreditDemandListDtoConfig : PerDtoConfig<PrtnCreditDemandListDto, PrtnCreditDemand>
    {
        public override Action<IMappingExpression<PrtnCreditDemand, PrtnCreditDemandListDto>> AlterReadMapping =>
            cfg => cfg
                ...
                .ForMember(x => x.ContractorPhoneNumber, x => x.MapFrom(ent => ent.BusinessmanUser.UserName))
