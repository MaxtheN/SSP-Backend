...
{
    public class NotificationDtoConfig : PerDtoConfig<NotificationDto, Notification>
    {
        public override Action<IMappingExpression<Notification, NotificationDto>> AlterReadMapping =>
            cfg => cfg
