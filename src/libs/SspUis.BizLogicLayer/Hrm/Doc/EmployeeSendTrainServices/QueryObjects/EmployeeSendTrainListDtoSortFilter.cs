...
public static class EmployeeSendTrainListDtoSortFilter
{
    public static IQueryable<EmployeeSendTrainListDto> SortFilter(this IQueryable<EmployeeSendTrainListDto> query
     , EmployeeSendTrainSortFilterOptions options)
    {
