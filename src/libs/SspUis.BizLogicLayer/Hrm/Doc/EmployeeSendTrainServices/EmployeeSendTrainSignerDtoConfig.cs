...
{
    public class EmployeeSendTrainSignerConfig : PerDtoConfig<EmployeeSendTrainSignerDto, EmployeeSendTrainSigner>
    {
        public override Action<IMappingExpression<EmployeeSendTrainSigner, EmployeeSendTrainSignerDto>> AlterReadMapping =>
            cfg => cfg
