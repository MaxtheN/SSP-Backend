...
{
    public class TempCalcKindSignerConfig : PerDtoConfig<TempCalcKindSignerDto, TempCalcKindSigner>
    {
        public override Action<IMappingExpression<TempCalcKindSigner, TempCalcKindSignerDto>> AlterReadMapping =>
            cfg => cfg
