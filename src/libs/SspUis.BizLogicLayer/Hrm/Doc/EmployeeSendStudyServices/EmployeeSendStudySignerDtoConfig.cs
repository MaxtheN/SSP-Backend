...
{
    public class EmployeeSendStudySignerConfig : PerDtoConfig<EmployeeSendStudySignerDto, EmployeeSendStudySigner>
    {
        public override Action<IMappingExpression<EmployeeSendStudySigner, EmployeeSendStudySignerDto>> AlterReadMapping =>
            cfg => cfg
