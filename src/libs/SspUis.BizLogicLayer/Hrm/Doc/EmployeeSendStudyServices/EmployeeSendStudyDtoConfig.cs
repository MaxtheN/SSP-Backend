...
public class EmployeeSendStudyDtoConfig : PerDtoConfig<EmployeeSendStudyDto, EmployeeSendStudy>
{
    public override Action<IMappingExpression<EmployeeSendStudy, EmployeeSendStudyDto>> AlterReadMapping =>
        cfg => cfg
