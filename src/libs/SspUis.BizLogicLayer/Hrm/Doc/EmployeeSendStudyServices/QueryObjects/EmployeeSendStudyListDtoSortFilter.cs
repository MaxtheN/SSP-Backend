...
public static class EmployeeSendStudyListDtoSortFilter
{
    public static IQueryable<EmployeeSendStudyListDto> SortFilter(this IQueryable<EmployeeSendStudyListDto> query
     , EmployeeSendStudySortFilterOptions options)
    {
