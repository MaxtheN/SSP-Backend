...
{
    public class WorkDayOffSignerConfig : PerDtoConfig<WorkDayOffSignerDto, WorkDayOffSigner>
    {
        public override Action<IMappingExpression<WorkDayOffSigner, WorkDayOffSignerDto>> AlterReadMapping =>
            cfg => cfg
