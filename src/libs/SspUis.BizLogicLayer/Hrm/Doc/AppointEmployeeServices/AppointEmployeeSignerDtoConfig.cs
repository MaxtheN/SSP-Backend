...
{
    public class AppointEmployeeSignerConfig : PerDtoConfig<AppointEmployeeSignerDto, AppointEmployeeSigner>
    {
        public override Action<IMappingExpression<AppointEmployeeSigner, AppointEmployeeSignerDto>> AlterReadMapping =>
            cfg => cfg
