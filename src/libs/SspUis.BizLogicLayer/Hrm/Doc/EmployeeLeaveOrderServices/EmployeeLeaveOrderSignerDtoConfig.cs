...
{
    public class EmployeeLeaveOrderSignerConfig : PerDtoConfig<EmployeeLeaveOrderSignerDto, EmployeeLeaveOrderSigner>
    {
        public override Action<IMappingExpression<EmployeeLeaveOrderSigner, EmployeeLeaveOrderSignerDto>> AlterReadMapping =>
            cfg => cfg
