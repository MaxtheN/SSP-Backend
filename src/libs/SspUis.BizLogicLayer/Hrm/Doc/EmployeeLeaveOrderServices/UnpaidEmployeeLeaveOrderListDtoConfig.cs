...
{
    public class UnpaidEmployeeLeaveOrderListDtoConfig : PerDtoConfig<UnpaidEmployeeLeaveOrderListDto, EmployeeLeaveOrderTable>
    {
        public override Action<IMappingExpression<EmployeeLeaveOrderTable, UnpaidEmployeeLeaveOrderListDto>> AlterReadMapping => cfg => cfg
