...
{
    public class ChastisementSignerConfig : PerDtoConfig<ChastisementSignerDto, ChastisementSigner>
    {
        public override Action<IMappingExpression<ChastisementSigner, ChastisementSignerDto>> AlterReadMapping =>
            cfg => cfg
