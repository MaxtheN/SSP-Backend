...
{
    public class PositionCategoryDtoConfig : PerDtoConfig<PositionCategoryDto, PositionCategory>
    {
        public override Action<IMappingExpression<PositionCategory, PositionCategoryDto>> AlterReadMapping => cfg => cfg
