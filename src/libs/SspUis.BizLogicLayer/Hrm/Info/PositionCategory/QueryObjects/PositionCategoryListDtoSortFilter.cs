...
{
    public static class PositionCategoryListDtoSortFilter
    {
        public static IQueryable<PositionCategoryListDto> SortFilter(this IQueryable<PositionCategoryListDto> query, ISortFilterOptions options)
        {
