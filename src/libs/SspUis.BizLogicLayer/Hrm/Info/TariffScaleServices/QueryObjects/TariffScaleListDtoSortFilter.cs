...
{
    public static class TariffScaleListDtoSortFilter
    {
        public static IQueryable<TariffScaleListDto> SortFilter(this IQueryable<TariffScaleListDto> query, ISortFilterOptions options)
        {
