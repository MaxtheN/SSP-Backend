...
{
    public static class StaffingIndicatorListDtoSortFilter
    {
        public static IQueryable<StaffingIndicatorListDto> SortFilter(this IQueryable<StaffingIndicatorListDto> query, ISortFilterOptions options)
        {
