...
{
    public static class TaxBenefitTypeListDtoSortFilter
    {
        public static IQueryable<TaxBenefitTypeListDto> SortFilter(this IQueryable<TaxBenefitTypeListDto> query, ISortFilterOptions options)
        {
