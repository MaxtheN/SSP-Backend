...
{
    public class TaxBenefitTypeDtoConfig : PerDtoConfig<TaxBenefitTypeDto, TaxBenefitType>
    {
        public override Action<IMappingExpression<TaxBenefitType, TaxBenefitTypeDto>> AlterReadMapping => cfg => cfg
