...
{
    public static class FixedMinimumValueListDtoSortFilter
    {
        public static IQueryable<FixedMinimumValueListDto> SortFilter(this IQueryable<FixedMinimumValueListDto> query, ISortFilterOptions options)
        {
