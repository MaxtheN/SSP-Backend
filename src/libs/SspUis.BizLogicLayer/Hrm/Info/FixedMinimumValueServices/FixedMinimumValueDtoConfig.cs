...
{
    public class FixedMinimumValueDtoConfig : PerDtoConfig<FixedMinimumValueDto, FixedMinimumValue>
    {
        public override Action<IMappingExpression<FixedMinimumValue, FixedMinimumValueDto>> AlterReadMapping => cfg => cfg
