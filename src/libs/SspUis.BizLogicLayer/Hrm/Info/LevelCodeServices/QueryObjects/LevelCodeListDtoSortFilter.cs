...
{
    public static class LevelCodeListDtoSortFilter
    {
        public static IQueryable<LevelCodeListDto> SortFilter(this IQueryable<LevelCodeListDto> query, ISortFilterOptions options)
        {
