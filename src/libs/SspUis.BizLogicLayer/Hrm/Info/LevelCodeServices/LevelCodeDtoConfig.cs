...
public class LevelCodeDtoConfig : PerDtoConfig<LevelCodeDto, LevelCode>
{
    public override Action<IMappingExpression<LevelCode, LevelCodeDto>> AlterReadMapping => cfg => cfg
