...
public class LanguageProficiencyDtoConfig : PerDtoConfig<LanguageProficiencyDto, LanguageProficiency>
{
    public override Action<IMappingExpression<LanguageProficiency, LanguageProficiencyDto>> AlterReadMapping => cfg => cfg
