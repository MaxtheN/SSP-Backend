...
{
    public static class ItemOfExpenseListDtoSortFilter
    {
        public static IQueryable<ItemOfExpenseListDto> SortFilter(this IQueryable<ItemOfExpenseListDto> query, ISortFilterOptions options)
        {
