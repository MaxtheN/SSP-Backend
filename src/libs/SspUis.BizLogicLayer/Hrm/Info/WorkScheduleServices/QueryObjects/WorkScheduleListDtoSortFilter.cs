...
{
    public static class WorkScheduleListDtoSortFilter
    {
        public static IQueryable<WorkScheduleListDto> SortFilter(this IQueryable<WorkScheduleListDto> query, ISortFilterOptions options)
        {
