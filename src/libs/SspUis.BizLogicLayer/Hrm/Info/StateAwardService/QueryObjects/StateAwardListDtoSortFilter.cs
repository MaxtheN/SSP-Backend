...
public static class StateAwardListDtoSortFilter
{
    public static IQueryable<StateAwardListDto> SortFilter(this IQueryable<StateAwardListDto> query, ISortFilterOptions options)
    {
