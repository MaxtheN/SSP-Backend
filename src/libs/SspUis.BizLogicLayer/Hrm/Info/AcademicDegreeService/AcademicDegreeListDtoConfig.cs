...
public class AcademicDegreeListDtoConfig : PerDtoConfig<AcademicDegreeListDto, AcademicDegree>
{
    public override Action<IMappingExpression<AcademicDegree, AcademicDegreeListDto>> AlterReadMapping => cfg => cfg
