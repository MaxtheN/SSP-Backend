...
{
    public static class PositionClassificationListDtoSortFilter
    {
        public static IQueryable<PositionClassificationListDto> SortFilter(this IQueryable<PositionClassificationListDto> query, ISortFilterOptions options)
        {
