...
{
    public class CalculationKindDtoConfig : PerDtoConfig<CalculationKindDto, CalculationKind>
    {
        public override Action<IMappingExpression<CalculationKind, CalculationKindDto>> AlterReadMapping => cfg => cfg
            ...
            .ForMember(x => x.ItemOfExpenseCode, x => x.MapFrom(ent => ent.ItemOfExpense.Code))
