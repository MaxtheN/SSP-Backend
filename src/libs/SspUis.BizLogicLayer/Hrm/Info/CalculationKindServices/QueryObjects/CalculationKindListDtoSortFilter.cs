...
{
    public static class CalculationKindListDtoSortFilter
    {
        public static IQueryable<CalculationKindListDto> SortFilter(this IQueryable<CalculationKindListDto> query, ISortFilterOptions options)
        {
