...
{
    public class QualificationCategoryDtoConfig : PerDtoConfig<QualificationCategoryDto, QualificationCategory>
    {
        public override Action<IMappingExpression<QualificationCategory, QualificationCategoryDto>> AlterReadMapping => cfg => cfg
