...
{
    public static class TariffScaleCoefListDtoSortFilter
    {
        public static IQueryable<TariffScaleCoefListDto> SortFilter(this IQueryable<TariffScaleCoefListDto> query, ISortFilterOptions options)
        {
