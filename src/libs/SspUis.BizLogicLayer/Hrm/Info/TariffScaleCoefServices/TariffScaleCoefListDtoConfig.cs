...
public class TariffScaleCoefListDtoConfig : PerDtoConfig<TariffScaleCoefListDto, TariffScaleCoef>
{
    public override Action<IMappingExpression<TariffScaleCoef, TariffScaleCoefListDto>> AlterReadMapping => cfg => cfg
