...
public class PositionTypeDtoConfig : PerDtoConfig<PositionTypeDto, PositionType>
{
    public override Action<IMappingExpression<PositionType, PositionTypeDto>> AlterReadMapping => cfg => cfg
