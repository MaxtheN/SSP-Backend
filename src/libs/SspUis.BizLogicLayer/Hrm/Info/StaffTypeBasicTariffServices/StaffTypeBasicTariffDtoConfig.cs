...
public class StaffTypeBasicTariffDtoConfig : PerDtoConfig<StaffTypeBasicTariffDto, StaffTypeBasicTariff>
{
    public override Action<IMappingExpression<StaffTypeBasicTariff, StaffTypeBasicTariffDto>> AlterReadMapping => cfg => cfg
