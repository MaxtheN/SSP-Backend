...
{
    public static class StaffTypeBasicTariffListDtoSortFilter
    {
        public static IQueryable<StaffTypeBasicTariffListDto> SortFilter(this IQueryable<StaffTypeBasicTariffListDto> query, ISortFilterOptions options)
        {
