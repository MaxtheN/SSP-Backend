...
public class DepartmentDtoConfig:PerDtoConfig<DepartmentDto,Department>
{
    public override Action<IMappingExpression<Department, DepartmentDto>> AlterReadMapping => 
        cfg=> cfg
