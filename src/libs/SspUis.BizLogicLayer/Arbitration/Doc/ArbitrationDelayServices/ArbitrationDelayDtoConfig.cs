...
public class ArbitrationDelayDtoConfig : PerDtoConfig<ArbitrationDelayDto, ArbitrationDelay>
{
	public override Action<IMappingExpression<ArbitrationDelay, ArbitrationDelayDto>> AlterReadMapping =>
	   cfg => cfg
