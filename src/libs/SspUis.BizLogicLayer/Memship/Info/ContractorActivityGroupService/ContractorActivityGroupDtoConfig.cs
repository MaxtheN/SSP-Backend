...
{
    public class ContractorActivityGroupDtoConfig : PerDtoConfig<ContractorActivityGroupDto, ContractorActivityGroup>
    {
        public override Action<IMappingExpression<ContractorActivityGroup, ContractorActivityGroupDto>> AlterReadMapping => cfg => cfg
