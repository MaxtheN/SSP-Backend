...
{
    public static class ContractorActivityTypeListDtoSortFilter
    {
        public static IQueryable<ContractorActivityTypeListDto> SortFilter(this IQueryable<ContractorActivityTypeListDto> query, ISortFilterOptions options)
        {
