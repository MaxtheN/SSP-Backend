...
{
    public static class ClaimThemeListDtoSortFilter
    {
        public static IQueryable<ClaimThemeListDto> SortFilter(this IQueryable<ClaimThemeListDto> query, ISortFilterOptions options)
        {
