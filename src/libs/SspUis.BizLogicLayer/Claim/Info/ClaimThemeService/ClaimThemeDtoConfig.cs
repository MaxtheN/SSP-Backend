...
{
    public class ClaimThemeDtoConfig : PerDtoConfig<ClaimThemeDto, ClaimTheme>
    {
        public override Action<IMappingExpression<ClaimTheme, ClaimThemeDto>> AlterReadMapping => cfg => cfg
