...
{
    public class ClaimOrganizationTypeDtoConfig : PerDtoConfig<ClaimOrganizationTypeDto, ClaimOrganizationType>
    {
        public override Action<IMappingExpression<ClaimOrganizationType, ClaimOrganizationTypeDto>> AlterReadMapping => cfg => cfg
