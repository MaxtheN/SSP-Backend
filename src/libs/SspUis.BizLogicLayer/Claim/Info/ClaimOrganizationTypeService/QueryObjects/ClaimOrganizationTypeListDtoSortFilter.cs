...
{
    public static class ClaimOrganizationTypeListDtoSortFilter
    {
        public static IQueryable<ClaimOrganizationTypeListDto> SortFilter(this IQueryable<ClaimOrganizationTypeListDto> query, ISortFilterOptions options)
        {
