...
namespace SspUis.BizLogicLayer.PositionServices
{
    ...
    {
        public static IQueryable<PositionListDto> SortFilter(this IQueryable<PositionListDto> query, ISortFilterOptions options)
        {
            ...
            if (options.HasSort())
                ...
                query = query.OrderByDescending(a => a.OrderCode);
