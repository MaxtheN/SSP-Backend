...
{
    public class ContractorSettlementAccountDtoConfig : PerDtoConfig<ContractorSettlementAccountDto, ContractorSettlementAccount>
    {
        public override Action<IMappingExpression<ContractorSettlementAccount, ContractorSettlementAccountDto>> AlterReadMapping =>
           cfg => cfg
