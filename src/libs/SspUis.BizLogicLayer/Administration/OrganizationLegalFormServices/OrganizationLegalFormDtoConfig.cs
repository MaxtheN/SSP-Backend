...
{
    public class OrganizationLegalFormDtoConfig : PerDtoConfig<OrganizationLegalFormDto, OrganizationLegalForm>
    {
        public override Action<IMappingExpression<OrganizationLegalForm, OrganizationLegalFormDto>> AlterReadMapping => cfg => cfg
