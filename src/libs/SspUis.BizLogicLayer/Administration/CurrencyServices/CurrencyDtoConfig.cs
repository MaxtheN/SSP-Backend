...
{
    public class CurrencyDtoConfig : PerDtoConfig<CurrencyDto, Currency>
    {
        public override Action<IMappingExpression<Currency, CurrencyDto>> AlterReadMapping => cfg => cfg
