...
{
    public static class CurrencyListDtoSortFilter
    {
        public static IQueryable<CurrencyListDto> SortFilter(this IQueryable<CurrencyListDto> query, ISortFilterOptions options)
        {
