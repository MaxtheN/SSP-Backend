...
public class EducationItemListDtoConfig : PerDtoConfig<EducationItemListDto, EducationItem>
{
    public override Action<IMappingExpression<EducationItem, EducationItemListDto>> AlterReadMapping => cfg => cfg
