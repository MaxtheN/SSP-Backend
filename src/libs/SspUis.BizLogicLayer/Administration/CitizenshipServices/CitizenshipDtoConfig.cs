...
{
    public class CitizenshipDtoConfig : PerDtoConfig<CitizenshipDto, Citizenship>
    {
        public override Action<IMappingExpression<Citizenship, CitizenshipDto>> AlterReadMapping => cfg => cfg
