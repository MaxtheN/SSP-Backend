...
{
    public class IdentityDocumentDtoConfig : PerDtoConfig<IdentityDocumentDto, IdentityDocument>
    {
        public override Action<IMappingExpression<IdentityDocument, IdentityDocumentDto>> AlterReadMapping => cfg => cfg
