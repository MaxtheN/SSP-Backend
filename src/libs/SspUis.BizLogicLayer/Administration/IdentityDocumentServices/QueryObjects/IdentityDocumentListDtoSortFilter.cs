...
{
    public static class IdentityDocumentListDtoSortFilter
    {
        public static IQueryable<IdentityDocumentListDto> SortFilter(this IQueryable<IdentityDocumentListDto> query, ISortFilterOptions options)
        {
