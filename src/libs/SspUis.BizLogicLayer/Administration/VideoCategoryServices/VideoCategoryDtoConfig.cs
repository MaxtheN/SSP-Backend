...
{
    public class VideoCategoryDtoConfig : PerDtoConfig<VideoCategoryDto, VideoCategory>
    {
        public override Action<IMappingExpression<VideoCategory, VideoCategoryDto>> AlterReadMapping => cfg => cfg
