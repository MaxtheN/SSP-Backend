...
{
    public class NationalityDtoConfig : PerDtoConfig<NationalityDto, Nationality>
    {
        public override Action<IMappingExpression<Nationality, NationalityDto>> AlterReadMapping => cfg => cfg
