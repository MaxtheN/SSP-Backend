...
{
    public class LandingPageDatumListDtoConfig : PerDtoConfig<LandingPageDatumListDto, LandingPageDatum>
    {
        public override Action<IMappingExpression<LandingPageDatum, LandingPageDatumListDto>> AlterReadMapping => cfg => cfg
