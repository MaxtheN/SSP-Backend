...
public class ContractorSurveyListDtoConfig : PerDtoConfig<ContractorSurveyListDto, ContractorSurvey>
{
    public override Action<IMappingExpression<ContractorSurvey, ContractorSurveyListDto>> AlterReadMapping =>
        cfg => cfg
