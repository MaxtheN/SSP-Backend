...
namespace SspUis.BizLogicLayer;
	...
	public static class IndicatorListDtoSortFilter
{
	public static IQueryable<IndicatorListDto> SortFilter(this IQueryable<IndicatorListDto> query, ISortFilterOptions options)
	{
