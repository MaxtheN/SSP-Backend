...
public class IndicatorListDtoConfig : PerDtoConfig<IndicatorListDto, Indicator>
{
	public override Action<IMappingExpression<Indicator, IndicatorListDto>> AlterReadMapping => cfg => cfg
