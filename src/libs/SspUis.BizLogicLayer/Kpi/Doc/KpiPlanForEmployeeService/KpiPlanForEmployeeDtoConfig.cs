...
internal class KpiPlanForEmployeeDtoConfig
: PerDtoConfig<KpiPlanForEmployeeDto, KpiPlanForEmployee>
{
    public override Action<IMappingExpression<KpiPlanForEmployee, KpiPlanForEmployeeDto>> AlterReadMapping =>
       cfg => cfg
