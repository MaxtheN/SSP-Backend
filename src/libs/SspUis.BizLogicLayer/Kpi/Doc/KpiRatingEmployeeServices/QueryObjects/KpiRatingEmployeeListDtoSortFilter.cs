...
public static class KpiRatingEmployeeListDtoSortFilter
{
    public static IQueryable<KpiRatingEmployeeListDto> SortFilter(this IQueryable<KpiRatingEmployeeListDto> query
     , KpiRatingEmployeeSortFilterOptions options)
    {
