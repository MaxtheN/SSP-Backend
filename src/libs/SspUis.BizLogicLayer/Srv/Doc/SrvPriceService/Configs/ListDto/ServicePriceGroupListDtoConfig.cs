...
{
    public class ServicePriceGroupListDtoConfig : PerDtoConfig<ServicePriceGroupListDto, ServicePriceGroup>
    {
        public override Action<IMappingExpression<ServicePriceGroup, ServicePriceGroupListDto>> AlterReadMapping =>
            cfg => cfg
