...
{
    public static class SrvApplicationListDtoFilter
    {
        public static IQueryable<SrvApplicationListDto> SortFilter(this IQueryable<SrvApplicationListDto> query, SrvApplicationSortFilterOptions options)
        {
