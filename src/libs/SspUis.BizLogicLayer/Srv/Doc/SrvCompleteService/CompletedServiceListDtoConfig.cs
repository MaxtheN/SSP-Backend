...
{
    public class CompletedServiceListDtoConfig : PerDtoConfig<CompletedServiceListDto, CompletedService>
    {
        public override Action<IMappingExpression<CompletedService, CompletedServiceListDto>> AlterReadMapping =>
            cfg => cfg
