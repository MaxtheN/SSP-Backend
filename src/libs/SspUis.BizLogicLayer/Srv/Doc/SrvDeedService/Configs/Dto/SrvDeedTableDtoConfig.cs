...
{
    public class SrvDeedTableDtoConfig : PerDtoConfig<SrvDeedTableDto, ServiceDeedTable>
    {
        public override Action<IMappingExpression<ServiceDeedTable, SrvDeedTableDto>> AlterReadMapping =>
            cfg => cfg
