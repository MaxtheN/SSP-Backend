...
{
    public static class SrvDeedListDtoSortFilter
    {
        public static IQueryable<SrvDeedListDto> SortFilter(this IQueryable<SrvDeedListDto> query
        , SrvDeedSortFilterOption options)
        {
