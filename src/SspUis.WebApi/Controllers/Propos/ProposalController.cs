...
namespace SspUis.WebApi.Controllers
{
    ...
    public class ProposalController : WebaseController
    {
        ...
        [HttpPost]
        [Authorize(ModuleCode.ProposalViewAll)]
        ...
        [HttpGet("{id}")]
        [Authorize(ModuleCode.ProposalView)]
        ...
        {
            ContractorDto result = await _service.GetfromSoliqByInn(inn);
        ...
        [HttpPost]
        [Authorize(ModuleCode.ProposalCreate)]
        ...
        [Authorize(ModuleCode.ProposalEdit)]
        ...
        [HttpPost("{id}")]
        [Authorize(ModuleCode.ProposalDelete)]
        [ProducesResponseType(200)]
