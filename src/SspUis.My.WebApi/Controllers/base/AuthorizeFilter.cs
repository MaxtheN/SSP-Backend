...
namespace SspUis.My.WebApi
{
    public class AuthorizeFilter : Attribute, IAuthorizationFilter
    {
        ...
        public virtual void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var authService = (IAuthService)context.HttpContext.RequestServices.GetRequiredService(typeof(IAuthService));
            ...
            {
                if (ModuleCodes == null || !ModuleCodes.Any(moduleCode => authService.HasPermission(moduleCode)))
