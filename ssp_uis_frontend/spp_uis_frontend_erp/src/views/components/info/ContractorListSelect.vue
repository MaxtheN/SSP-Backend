<template>
   <div>
      ...
      <!-- ContractorList -->
      <b-modal size="xl" :title="$t('contractor')" v-model="dialog" hide-footer>
         <ContractorList :selectable="true" @row-selected="rowSelect" />
      </b-modal>
   </div>
</template>
...
import ContractorList from '@/views/components/info/ContractorList.vue';
export default {
   components: {
      BButton,
      BModal,
