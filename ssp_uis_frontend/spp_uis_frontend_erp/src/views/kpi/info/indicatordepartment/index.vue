   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'IndicatorDepartmentCreate'
         },
         edit: {
            name: 'EditIndicatorDepartment',
            permission: 'IndicatorDepartmentEdit'
         },
         delete: {
            name: 'EditIndicatorDepartment',
            permission: 'IndicatorDepartmentDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         IndicatorDepartmentService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         IndicatorDepartmentService.GetList(this.filter)
            .then((res) => {
