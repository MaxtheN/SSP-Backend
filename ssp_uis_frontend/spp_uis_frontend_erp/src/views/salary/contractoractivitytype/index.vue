   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'ContractorActivityTypeCreate'
         },
         edit: {
            name: 'EditContractorActivityType',
            permission: 'ContractorActivityTypeEdit'
         },
         delete: {
            name: 'EditContractorActivityType',
            permission: 'ContractorActivityTypeDelete'
         }
      }"
...
export default {
   ...
   data() {
      return {
         ...
         fields: [
            ...
            {
               key: 'contractorActivityGroup',
               label: this.$t('ContractorActivityGroup'),
               sortable: true
            },
            {
               key: 'fullName',
   ...
   methods: {
      ...
      Delete(item) {
         ...
         ContractorActivityTypeService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         ContractorActivityTypeService.GetList(this.filter)
            .then((res) => {
