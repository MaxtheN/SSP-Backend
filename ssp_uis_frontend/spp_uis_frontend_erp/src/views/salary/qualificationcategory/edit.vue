...
<script>
// service
import QualificationCategoryService from '@/services/hrm/qualificationcategory.service';
// components
...
export default {
   ...
   created() {
      this.show = true;
      QualificationCategoryService.Get(this.$route.params.id)
         .then((res) => {
            this.Data = res.data;
         })
         .catch((error) => {
      ...
      SaveData() {
         this.$refs.ValidationDTO.validate().then((success) => {
            if (success) {
               ...
               QualificationCategoryService.Update(this.Data)
                  .then(() => {
                     this.makeToast(this.$t('SaveSuccess'), 'success');
                     this.$router.push({ name: 'QualificationCategory' });
                  })
                  .catch((err) => {
