   ...
   computed: {
      ...
      IframeSrc() {
         return (
            ...
            `hrm/OrderToSendBusinessTrip/DownloadPdf?id2=${this.Data?.id2}&lang=${this.getPdfLang()}`
         );
      }
   },
   methods: {
      ...
      DownloadTemplate1() {
         changeDocument.DownloadTemplate(
            '/hrm/OrderToSendBusinessTrip/DownloadTemplate',
            this.$t('OrderToSendBusinessTrip')
         );
      },
      UploadFile(event) {
         changeDocument.UploadFile('hrm/OrderToSendBusinessTrip/UploadFile', event).then((res) => {
            this.Data.files.length = 0;
            this.Data.files.push(res.data[0]);
            changeDocument
               .Update('/hrm/OrderToSendBusinessTrip/Update', this.Data)
               .then((res) => {
