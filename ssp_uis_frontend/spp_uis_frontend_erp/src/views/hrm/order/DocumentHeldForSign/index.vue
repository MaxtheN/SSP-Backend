         ...
         <template #cell(actions)="{ item }">
            <div class="text-center" style="text-wrap: nowrap">
               ...
               <b-link
                  ...
                  v-if="$can('SignerView', 'permissions')"
...
import DocumentHeldForSignService from '@/services/hrm/DocumentHeldForSign.service';
...
export default {
   ...
   methods: {
      ...
      Refresh() {
         ...
         this.isBusy = true;
         DocumentHeldForSignService.GetHrmDocumentList(this.filter)
            .then((res) => {
