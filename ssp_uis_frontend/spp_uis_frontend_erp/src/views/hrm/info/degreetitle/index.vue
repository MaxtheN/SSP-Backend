   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'DegreeTitleCreate'
         },
         edit: {
            name: 'EditDegreeTitle',
            permission: 'DegreeTitleEdit'
         },
         delete: {
            name: 'EditDegreeTitle',
            permission: 'DegreeTitleDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         DegreeTitleService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         DegreeTitleService.GetList(this.filter)
            .then((res) => {
