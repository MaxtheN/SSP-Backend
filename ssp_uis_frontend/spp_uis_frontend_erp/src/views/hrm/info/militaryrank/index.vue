   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'MilitaryRankCreate'
         },
         edit: {
            name: 'EditMilitaryRank',
            permission: 'MilitaryRankEdit'
         },
         delete: {
            name: 'EditMilitaryRank',
            permission: 'MilitaryRankDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         MilitaryRankService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         MilitaryRankService.GetList(this.filter)
            .then((res) => {
