   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'ScientificDegreeCreate'
         },
         edit: {
            name: 'EditScientificDegree',
            permission: 'ScientificDegreeEdit'
         },
         delete: {
            name: 'EditScientificDegree',
            permission: 'ScientificDegreeDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         ScientificDegreeService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         ScientificDegreeService.GetList(this.filter)
            .then((res) => {
