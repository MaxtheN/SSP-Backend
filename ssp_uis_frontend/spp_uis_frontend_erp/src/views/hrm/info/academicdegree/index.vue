   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'AcademicDegreeCreate'
         },
         edit: {
            name: 'EditAcademicDegree',
            permission: 'AcademicDegreeEdit'
         },
         delete: {
            name: 'EditAcademicDegree',
            permission: 'AcademicDegreeDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         AcademicDegreeService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         AcademicDegreeService.GetList(this.filter)
            .then((res) => {
