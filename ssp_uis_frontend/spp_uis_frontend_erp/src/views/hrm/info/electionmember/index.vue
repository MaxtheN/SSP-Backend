   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'ElectionMemberCreate'
         },
         edit: {
            name: 'EditElectionMember',
            permission: 'ElectionMemberEdit'
         },
         delete: {
            name: 'EditElectionMember',
            permission: 'ElectionMemberDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         ElectionMemberService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         ElectionMemberService.GetList(this.filter)
            .then((res) => {
