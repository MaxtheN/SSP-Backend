   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'PositionTypeCreate'
         },
         edit: {
            name: 'EditPositionType',
            permission: 'PositionTypeEdit'
         },
         delete: {
            name: 'EditPositionType',
            permission: 'PositionTypeDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         PositionTypeService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         PositionTypeService.GetList(this.filter)
            .then((res) => {
