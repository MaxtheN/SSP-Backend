...
export default {
   ...
   created() {
      if (this.$route.query.courtId) {
         ArbitrationDelayService.GetByArbitrationCourtApplicationId(this.$route.query.courtId)
            .then((res) => {
               this.Data = res.data;
            })
            .catch((error) => {
         ...
         ArbitrationDelayService.Get(this.$route.params.id)
            .then((res) => {
               this.Data = res.data;
            })
            .catch((error) => {
   ...
   methods: {
      ...
      UploadFile(event) {
         ...
         ArbitrationDelayService.UploadFile(formData).then((res) => {
      ...
      DeleteFile() {
         ...
         ArbitrationDelayService.DeleteFile(this.Data.files[0].id).then((_res) => {
      ...
      DownloadFile() {
         ArbitrationDelayService.DownloadFile(this.Data.files[0].id).then((res) => {
      ...
      SaveData() {
         this.$refs.ValidationDTO.validate().then((success) => {
            if (success) {
               ...
               ArbitrationDelayService.Update(this.Data)
                  .then((res) => {
                     this.makeToast(this.$t('SaveSuccess'), 'success');
                     ArbitrationDelayService.Get(res.data.id)
                        .then((res1) => {
                           this.Data = res1.data;
                        })
                        .catch((error) => {
