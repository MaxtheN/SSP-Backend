   ...
   >
      ...
      <template #cell(actions)="{ item }">
         <div class="text-center">
            ...
            <b-link
               :to="{ name: 'EditArbitrationResult', params: { id: item.id } }"
...
export default {
   ...
   methods: {
      ...
      Refresh() {
         this.isBusy = true;
         ArbitrationResultService.GetList(this.filter)
            .then((res) => {
      ...
      Delete(item) {
         ...
         ArbitrationResultService.Delete(item.id)
            .then(() => {
