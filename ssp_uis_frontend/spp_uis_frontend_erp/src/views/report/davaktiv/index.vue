<template>
   <b-card>
      ...
      <b-overlay :show="isBusy">
         <b-table-simple hover small caption-top responsive border class="report-table mt-2">
            <b-thead>
               <b-tr>
               ...
               <b-tr>
                  <b-th colspan="3" style="font-weight: 900; font-size: 14px; color: black">{{
                     $t(
                        'давлат кўчмас мулки объектлари ёки ерга бўлган ҳуқуқларни сотиб олиш билан боғлиқ тўловлар қуйидаги муддатларда амалга оширилади'
                     )
                  }}</b-th>
               </b-tr>
               <b-tr>
                  ...
                  <b-th
                     >{{ $t('51-100 нафар') }} <br />
                     <span style="color: red; white-space: nowrap"> {{ $t('(3 йилдан кўп бўлмаган муддатда)') }}</span>
                  </b-th>
                  <b-th
                     >{{ $t('101-200 нафар') }} <br />
                     <span style="color: red; white-space: nowrap">{{ $t('(4 йилдан кўп бўлмаган муддатда)') }}</span>
                  </b-th>
                  <b-th
                     >{{ $t('200 нафардан ортиқ') }} <br /><span style="color: red; white-space: nowrap">{{
                        $t('(5 йилдан кўп бўлмаган муддатда)')
                     }}</span>
                  </b-th>
               </b-tr>
            </b-thead>
...
export default {
   ...
   methods: {
      ...
      Print() {
         ReportService.SaveAsExcelDavaktivImtiyoz(this.filter).then((res) => {
