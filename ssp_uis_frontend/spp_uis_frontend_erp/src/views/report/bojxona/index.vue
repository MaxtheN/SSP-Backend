               ...
               <b-thead>
                  ...
                  <b-tr>
                     <b-th colspan="3" style="font-weight: 900; font-size: 14px; color: black">{{
                        $t('PaymentDutiesWithoutSecurityAndWithoutInterest')
                     }}</b-th>
                     <b-th rowspan="2"
                        ><span style="font-weight: 900; font-size: 14px; color: black">{{ $t('Applying') }}</span>
                        <br />
                     </b-th>
                  </b-tr>
                  <b-tr>
                     ...
                     <b-th
                        >{{ $t('51-100people') }} <br />
                        <!-- <span style="color: red; white-space: nowrap"> {{ $t('3Months') }}</span> -->
                     </b-th>
                     <b-th>{{ $t('101-200people') }} <br /> </b-th>
                     <b-th>{{ $t('MoreThan200people') }} <br /> </b-th>
                  </b-tr>
               </b-thead>
...
export default {
   ...
   methods: {
      ...
      Print() {
         ReportService.SaveAsExcelBojxonaImtiyoz(this.filter).then((res) => {
