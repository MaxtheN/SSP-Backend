            ...
            <b-table-simple class="report-table" hover caption-top responsive striped border>
               <b-thead>
                  <b-tr>
                     ...
                     <b-th colspan="18">{{ $t('shundan') }}</b-th>
                  </b-tr>
                  <b-tr>
                  ...
                  <b-tr>
                     <template v-for="h in 4">
                        <b-th rowspan="2" :key="h + 'col1'">{{ $t('Субъект сони') }}</b-th>
               ...
               <b-tbody v-if="items.length > 0">
                  <b-tr v-for="(item, idx) in items" :key="idx + 'abc'">
                     ...
                     <b-td class="text-right">
                        {{ currency(item.application.canceledCount + item.application.rejectedCount) }}
                     </b-td>
                     ...
                     <b-td class="text-right">
                        {{ currency(item.contractType1.canceledCount + item.contractType1.rejectedCount) }}
                     </b-td>
                     <b-td class="text-right"> 0 </b-td>
                     <b-td class="text-right">
                     ...
                     <b-td class="text-right">
                        {{ currency(item.contractType2.canceledCount + item.contractType2.rejectedCount) }}
                     </b-td>
                     <b-td class="text-right"> 0 </b-td>
                     <b-td class="text-right">
                     ...
                     <b-td class="text-right">
                        {{ currency(item.contractType3.canceledCount + item.contractType3.rejectedCount) }}
                     </b-td>
                     <b-td class="text-right"> 0 </b-td>
                     <b-td class="text-right">
               ...
               <b-tfoot v-if="items.length > 0">
                  <b-tr variant="secondary">
                     ...
                     <b-td class="text-right">
                        {{ currency(totals.rejectAndCancel) }}
                     </b-td>
                     <b-td class="text-right">
                     ...
                     <b-td class="text-right">
                        {{ currency(totals.rejectAndCancel1) }}
                     </b-td>
                     <b-td class="text-right">
                     ...
                     <b-td class="text-right">
                        {{ currency(totals.rejectAndCancel2) }}
                     </b-td>
                     <b-td class="text-right">
                     ...
                     <b-td class="text-right">
                        {{ currency(totals.rejectAndCancel3) }}
                     </b-td>
                     <b-td class="text-right">
         ...
         ReportService.GetBankCreditReport(this.filter)
            .then((res) => {
               ...
               res.data.forEach((item) => {
                  ...
                  this.totals.rejectAndCancel += item.application.canceledCount + item.application.rejectedCount;
                  ...
                  this.totals.rejectAndCancel1 += item.contractType1.canceledCount + item.contractType1.rejectedCount;
                  ...
                  this.totals.rejectAndCancel2 += item.contractType2.canceledCount + item.contractType2.rejectedCount;
                  ...
                  this.totals.rejectAndCancel3 += item.contractType3.canceledCount + item.contractType3.rejectedCount;
