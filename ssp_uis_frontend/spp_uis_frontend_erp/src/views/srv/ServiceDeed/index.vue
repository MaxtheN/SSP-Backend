   ...
   >
      ...
      <template #filter>
         <b-row>
            ...
            <b-col cols="auto">
               <b-button @click="Print" :disabled="Printloading" class="mt-2" variant="primary">
      ...
      <template #cell(actions)="{ item }">
         <div class="text-center" style="text-wrap: nowrap">
            <!-- Edit -->
            <b-link
               :to="{ name: 'EditServiceDeed', params: { id: item.id } }"
            ...
            <!-- delete -->
            <!-- <b-link
               v-if="$can('ServiceDeedDelete', 'permissions')"
   ...
   methods: {
      ...
      Delete(item) {
         this.$swal.fire({
            ...
            preConfirm: () => {
               return ServiceDeedService.Delete(item.id)
                  .then(() => {
      ...
      Print() {
         ...
         ServiceDeedService.SaveAsExcel(this.filter)
            .then((res) => {
