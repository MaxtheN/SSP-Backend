   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'CompleteServiceCreate'
         },
         edit: {
            name: 'EditCompleteService',
            permission: 'CompleteServiceEdit'
         },
         delete: {
            name: 'EditCompleteService',
            permission: 'CompleteServiceDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         CompleteServiceService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         CompleteServiceService.GetList(this.filter)
            .then((res) => {
