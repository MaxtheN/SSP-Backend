   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'NeedChamberServiceGroupCreate'
         },
         edit: {
            name: 'EditNeedChamberServiceGroup',
            permission: 'NeedChamberServiceGroupEdit'
         },
         delete: {
            name: 'EditNeedChamberServiceGroup',
            permission: 'NeedChamberServiceGroupDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         NeedChamberServiceGroupService.Delete(item.id)
            .then(() => {
