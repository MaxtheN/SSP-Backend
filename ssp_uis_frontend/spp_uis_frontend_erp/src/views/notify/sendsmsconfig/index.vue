   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'SendSmsConfigCreate'
         },
         edit: {
            name: 'EditSendSmsConfig',
            permission: 'SendSmsConfigEdit'
         },
         delete: {
            name: 'EditSendSmsConfig',
            permission: 'SendSmsConfigDelete'
         }
      }"
...
export default {
   ...
   data() {
      return {
         ...
         fields: [
            ...
            {
               key: 'fromStatus',
               label: this.$t('fromStatus')
            },
            {
               key: 'toStatus',
               label: this.$t('toStatus')
            },
            {
               key: 'stateId',
               label: this.$t('status'),
   ...
   methods: {
      ...
      Delete(item) {
         ...
         SendSmsConfigService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         SendSmsConfigService.GetList(this.filter)
            .then((res) => {
