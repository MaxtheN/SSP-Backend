   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'AppealTypeArriveCreate'
         },
         edit: {
            name: 'EditAppealTypeArrive',
            permission: 'AppealTypeArriveEdit'
         },
         delete: {
            name: 'EditAppealTypeArrive',
            permission: 'AppealTypeArriveDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         AppealTypeArriveService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         AppealTypeArriveService.GetList(this.filter)
            .then((res) => {
