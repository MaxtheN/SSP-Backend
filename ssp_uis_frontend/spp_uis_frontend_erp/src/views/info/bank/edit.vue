               ...
               <validation-observer ref="ValidationDTO">
                  <b-row>
                     <b-col sm="12" md="4" class="mb-1">
                        <form-input v-model="Data.orderCode" type="string" :label="$t('orderCode')" />
                     </b-col>
                     <b-col sm="12" md="4" class="mb-1">
                        <form-input v-model="Data.code" type="string" required :label="$t('kode')" />
                     </b-col>
                     <b-col sm="12" md="4" class="mb-1">
                     ...
                     <b-col sm="12" md="4" class="mb-1">
                        <form-select :options="BankCodeList" v-model="Data.bankCodeId" label="bankcode"> </form-select>
                     </b-col>
...
export default {
   ...
   created() {
      this.show = true;
      BankService.Get(this.$route.params.id)
         .then((res) => {
            this.Data = res.data;
         })
         .catch((error) => {
      ...
      ManualService.BankCodeSelectList()
         .then((res) => {
