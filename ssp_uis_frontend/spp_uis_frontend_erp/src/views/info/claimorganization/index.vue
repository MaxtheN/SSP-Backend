   ...
   <form-table-hrm
      ...
      :actions="{
         create: {
            ...
            permission: 'ClaimOrganizationCreate'
         },
         edit: {
            name: 'EditClaimOrganization',
            permission: 'ClaimOrganizationEdit'
         },
         delete: {
            name: 'EditClaimOrganization',
            permission: 'ClaimOrganizationDelete'
         }
      }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         ClaimOrganizationService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         ClaimOrganizationService.GetList(this.filter)
            .then((res) => {
