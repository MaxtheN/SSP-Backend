...
<script>
// service
import ClaimOrganizationTypeService from '@/services/info/claimorganizationtype.service';
// components
...
export default {
   ...
   name: 'ClaimOrganizationTypeEdit',
   data() {
      return {
         show: false,
         saveLoading: false,
   ...
   created() {
      this.show = true;
      ClaimOrganizationTypeService.Get(this.$route.params.id)
         .then((res) => {
            this.Data = res.data;
         })
         .catch((error) => {
      ...
      SaveData() {
         this.$refs.ValidationDTO.validate().then((success) => {
            if (success) {
               ...
               ClaimOrganizationTypeService.Update(this.Data)
                  .then(() => {
                     this.makeToast(this.$t('SaveSuccess'), 'success');
                     this.$router.push({ name: 'ClaimOrganizationType' });
                  })
                  .catch((err) => {
