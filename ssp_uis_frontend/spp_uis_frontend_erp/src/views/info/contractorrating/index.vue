   ...
   <b-card no-body>
      <div class="m-2">
         <b-row>
            <b-col cols="12" md="6" class="d-flex align-items-center justify-content-start mb-1 mb-md-0">
               <b-button variant="primary" :to="{ name: 'ContractorRatingEdit', params: { id: 0 } }">
      ...
      >
         <template #cell(status)="{ item }">
            <!-- <b-badge :variant="item.stateId == '2' ? 'light-danger' : 'light-success'"></b-badge> -->
            {{ item.state }}
         </template>
         <template #cell(actions)="{ item }">
            <b-link
               :to="{ name: 'ContractorRatingEdit', params: { id: item.id } }"
      ...
      <div class="mx-2 mb-2">
         <b-row>
            <b-col cols="12" sm="3" class="d-flex align-items-center justify-content-center justify-content-sm-start">
...
export default {
      ...
      return {
         ...
         fields: [
            ...
            },
            {
               ...
               label: this.$t('minimumPercentage'),
               thClass: 'text-center',
               tdClass: 'text-right',
               sortable: true
            },
            {
               ...
               label: this.$t('maximumPercentage'),
               thClass: 'text-center',
   ...
   methods: {
      ...
      Delete(item) {
         ...
         ContractorRatingService.Delete(item.id)
            .then((res) => {
      ...
      Refresh() {
         this.isBusy = true;
         ContractorRatingService.GetList(this.filter).then((res) => {
