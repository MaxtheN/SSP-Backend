...
<script>
// service
import ContractorUnionActivityTypeService from '@/services/info/contractorunionactivitytype.service';
// components
...
export default {
   ...
   name: 'ContractorUnionActivityTypeEdit',
   data() {
      return {
         show: false,
         saveLoading: false,
   ...
   created() {
      this.show = true;
      ContractorUnionActivityTypeService.Get(this.$route.params.id)
         .then((res) => {
            this.Data = res.data;
         })
         .catch((error) => {
      ...
      SaveData() {
         this.$refs.ValidationDTO.validate().then((success) => {
            if (success) {
               ...
               ContractorUnionActivityTypeService.Update(this.Data)
                  .then(() => {
                     this.makeToast(this.$t('SaveSuccess'), 'success');
                     this.$router.push({ name: 'ContractorUnionActivityType' });
                  })
                  .catch((err) => {
