<template>
    <div class="border-l-red-400 flex items-center rounded-md border-l-[6px] bg-white p-5 pl-6">
        <div class=" flex w-full max-w-[36px] items-center justify-center rounded-full">
        ...
        <div class="flex w-full items-center justify-between">
            <div>
                <h3 class="mb-1 text-lg font-medium text-black">Opps!</h3>
                <p class="text-body-color dark:text-dark-6 text-sm">Hujjatni yuklashda xatolik ro'y berdi</p>
            </div>
        </div>
    </div>
</template>
